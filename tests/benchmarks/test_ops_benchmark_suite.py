...
def test_dtype_benchmark_cases_keep_specific_filters():
    ...
    expected = {
        ...
        "add_float16": "fused_elementwise_gpu.j2",
        "mul_bfloat16": "fused_elementwise_gpu.j2",
        "cast_float16": "fused_elementwise_gpu.j2",
        "full_bool": "full_gpu.j2",
        "full_float16": "full_gpu.j2",
        "full_bfloat16": "full_gpu.j2",
        "arange_float16": "arange_gpu.j2",
        "arange_bfloat16": "arange_gpu.j2",
        "randn_float16": "randn_gpu.j2",
        "randn_torch_float16": "randn_gpu.j2",
        "randn_bfloat16": "randn_gpu.j2",
        "randn_torch_bfloat16": "randn_gpu.j2",
        "softmax_float16": "softmax_gpu.j2",
        "softmax_bfloat16": "softmax_gpu.j2",
        "reduce_sum_float16": "reduction_gpu.j2",
        "reduce_sum_bfloat16": "reduction_gpu.j2",
        "reduce_mean_float16": "reduction_gpu.j2",
        "avg_pool2d_bfloat16": "avg_pool2d_gpu.j2",
        "argmax_float16": "argmax_gpu.j2",
        "argmax_bool": "argmax_gpu.j2",
        "argmax_int64": "argmax_gpu.j2",
        "topk_bfloat16": "topk_gpu.j2",
        "topk_bool": "topk_gpu.j2",
        "layer_norm_bfloat16": "layer_norm_gpu.j2",
        "get_timestep_embedding_float16": "get_timestep_embedding_gpu.j2",
        "get_1d_rotary_pos_embed_bfloat16": "get_1d_rotary_pos_embed_gpu.j2",
        "embedding_float16_int32": "embedding_gpu.j2",
        "embedding_bfloat16_int32": "embedding_gpu.j2",
        "gather_float16_int32": "gather_gpu.j2",
        "gather_bfloat16_int32": "gather_gpu.j2",
        "batch_gather_float16_int32": "gather_gpu.j2",
        "batch_gather_bfloat16_int32": "gather_gpu.j2",
        "permute0213": "permute_gpu.j2",
        "slice_scatter_bfloat16": "slice_scatter_gpu.j2",
    }
