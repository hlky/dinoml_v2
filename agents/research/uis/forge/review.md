...
- UI clone: `lllyasviel/stable-diffusion-webui-forge`
...
- `lllyasviel/stable-diffusion-webui-forge/README.md:15`
  links Flux BitsAndBytes/NF4/offload tutorial.
- `lllyasviel/stable-diffusion-webui-forge/README.md:17`
  links Flux separated full models and GGUF tutorial.
- `lllyasviel/stable-diffusion-webui-forge/README.md:21`
  discusses low-bit LoRA handling.
- `lllyasviel/stable-diffusion-webui-forge/README.md:35`
  states native Flux BNB NF4/GGUF support and LoRA support.
- `lllyasviel/stable-diffusion-webui-forge/README.md:75`
  lists LoRA status.
- `lllyasviel/stable-diffusion-webui-forge/README.md:77`
  lists ControlNet status.
- `lllyasviel/stable-diffusion-webui-forge/README.md:78`
...
- `lllyasviel/stable-diffusion-webui-forge/extensions-builtin/forge_legacy_preprocessors/annotator/`
  contains local annotator model implementations.
- `lllyasviel/stable-diffusion-webui-forge/modules_forge/supported_preprocessor.py`
  defines the preprocessor registration contract.
- `lllyasviel/stable-diffusion-webui-forge/modules_forge/supported_controlnet.py`
  defines ControlNet patching/loading behavior.
- `lllyasviel/stable-diffusion-webui-forge/modules_forge/shared.py`
  defines ControlNet and preprocessor model directories.
- `lllyasviel/stable-diffusion-webui-forge/packages_3rdparty/gguf/constants.py`
...
- LayerDiffuse transparent image editing is called out as an integrated feature.
  Anchor: `lllyasviel/stable-diffusion-webui-forge/README.md:29`.
- FreeU V2 is integrated as a runtime/generation modifier.
  Anchors: `lllyasviel/stable-diffusion-webui-forge/README.md:98`,
  `lllyasviel/stable-diffusion-webui-forge/extensions-builtin/sd_forge_freeu/scripts/forge_freeu.py:65`.
- Runtime formats include `bnb-fp4` and torch float8 `e4m3`/`e5m2`, in addition
  to NF4/GGUF.
  Anchor: `lllyasviel/stable-diffusion-webui-forge/modules_forge/main_entry.py:29`.
- Union ControlNets and OFT LoRAs should be documented with their explicit
  ...
  Anchors: `lllyasviel/stable-diffusion-webui-forge/README.md:89`,
  `lllyasviel/stable-diffusion-webui-forge/README.md:92`.
