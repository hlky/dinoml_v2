...
`debug/profile_report.json`, and stores a small `profile_cache.v2.json` beside
...
libraries. The first candidate is always `manifest_default`; future work should
expand that into generated CUTLASS candidate sets.
