...
def test_rocm_functional_conv2d_parity(case, tmp_path):
    ...
    dtype = "float16"
    spec = trace_functional_conv2d_spec(case, dtype=dtype)
    ...
    np.testing.assert_allclose(actual, expected, atol=0.005, rtol=0.003)
