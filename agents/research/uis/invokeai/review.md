...
- UI clone: `H:/uis/invoke-ai/InvokeAI`
...
- `H:/uis/invoke-ai/InvokeAI/README.md:64` starts supported model list.
- `H:/uis/invoke-ai/InvokeAI/README.md:68` lists Flux.1 support.
- `H:/uis/invoke-ai/InvokeAI/README.md:74` lists Flux.2 Klein support.
- `H:/uis/invoke-ai/InvokeAI/README.md:76` lists Z-Image support.
- `H:/uis/invoke-ai/InvokeAI/README.md:79` lists Qwen Image support.
- `H:/uis/invoke-ai/InvokeAI/README.md:83` lists Wan API-only support.
- `H:/uis/invoke-ai/InvokeAI/README.md:87` documents ckpt/diffusers/GGUF
  support.
- `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/taxonomy.py`
  defines base model, model type, and format taxonomy.
- `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/configs/main.py`
  configures main model identification.
- `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/configs/lora.py`
  configures LoRA models.
- `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/configs/textual_inversion.py:28`
  configures textual inversion.
- `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/configs/vae.py:74`
  configures standalone VAE checkpoints.
- `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/configs/vae.py:163`
  configures Flux.2 VAE checkpoints.
- `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/configs/vae.py:201`
  configures Qwen Image VAE checkpoints.
- `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/configs/t2i_adapter.py:27`
...
- `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/hed.py`
  implements HED edge detection invocation.
- `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/mlsd.py:16`
  implements MLSD detection invocation.
- `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/pidi.py:16`
  implements PiDiNet edge detection invocation.
- `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/normal_bae.py`
  implements NormalBae invocation.
- `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/segment_anything.py:58`
  implements SAM/SAM2 mask invocation.
- `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/configs/controlnet.py:38`
  maps lineart/scribble preprocessor hints.
- `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/z_image_control.py:25`
  defines Z-Image spatial control modes.
- `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/tiled_multi_diffusion_denoise_latents.py:40`
...
- Base taxonomy includes newer families not fully reflected in the first pass:
  ...
  Anchor: `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/taxonomy.py:49`.
- Model/component taxonomy includes ONNX, T5Encoder, Qwen3Encoder,
  ...
  formats.
  Anchors: `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/taxonomy.py:68`,
  `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/taxonomy.py:86`,
  `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/taxonomy.py:196`.
- Config factory and LoRA configs explicitly support Flux2, CogView4,
  ...
  LoRA forms.
  Anchors: `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/configs/factory.py:173`,
  `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/configs/lora.py:681`.
- Anima has a distinct invocation suite with Qwen3 encoder, Wan/QwenImage VAE,
  ...
  Anchors:
  `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/anima_model_loader.py:42`,
  `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/anima_text_encoder.py:62`.
- CogView4 has loader, text encoder, denoise, and image-to-latents invocations.
  Anchors:
  `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/cogview4_model_loader.py:36`,
  `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/cogview4_denoise.py:40`.
- Text LLM/prompt expansion is a product surface with model type, loader,
  ...
  Anchors: `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/taxonomy.py:86`,
  `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/text_llm.py:22`,
  `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/starter_models.py:880`.
- Qwen2.5-VL has standalone/quantized encoder support, including fp8-scaled
  starter models.
  Anchors: `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/configs/qwen_vl_encoder.py:50`,
  `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/starter_models.py:681`.
- Z-Image control support includes ControlNet config, invocation, and
  GGUF-aware denoise path.
  Anchors: `H:/uis/invoke-ai/InvokeAI/invokeai/backend/model_manager/configs/controlnet.py:250`,
  `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/z_image_control.py:64`,
  `H:/uis/invoke-ai/InvokeAI/invokeai/app/invocations/z_image_denoise.py:428`.
